/**
 * Summarization prompts for LLM-based context compaction
 */
...
export const SUMMARIZATION_SYSTEM_PROMPT = `You are a precise coding assistant that summarizes conversations. Your task is to create accurate, structured summaries that preserve all important context.`;
